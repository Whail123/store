...
print("总销售额",(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+
              253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+
              65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+
              135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+
              65.8*63+96.8*78))
print("每日平均销售数量",(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+
...
print("牛仔库月销售占比",(517/1844))
print("皮草月销售占比",(207/1844))
print("羽绒服月销售占比",(239/1844))
